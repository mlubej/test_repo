...
Slika X prikazuje rezultate luščenja na pravih podatkih in na vseh MC podatkih, Slika X pa prikazuje primer posameznega prilagajanja predlog MC podatkom. Število kandidatov kontrolnega razpada na podlagi luščenja so
