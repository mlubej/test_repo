...
This chapter shows the procedure in suppressing various kinds of backgrounds by applying cuts to MVA classifier outputs. More information about the MVA training, feature importance and hyper-parameter optimization for each MVA step in this chapter can be found in the Appendix \ref{sec:mva-control-plots}.
