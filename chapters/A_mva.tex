\chapter{MVA Control Plots}
%\section{Hadronic decay MVA training}\label{sec:hadronic-decay-mva-training}
%
%\subsection{Variable importance}
%
%\begin{longtable}{| p{.045\textwidth} | p{.59\textwidth} | p{.045\textwidth} |p{.2\textwidth} |}
%\hline
%& Name & Alias & Importance \\ \hline
%0 &\texttt{\footnotesize B\_qpKinLepton} & $v_{0}$ & $0.510$ \\ \hline
%1 &\texttt{\footnotesize B\_qpIntermediateKinLepton} & $v_{1}$ & $0.170$ \\ \hline
%2 &\texttt{\footnotesize B\_nLepInROE} & $v_{2}$ & $0.151$ \\ \hline
%3 &\texttt{\footnotesize B\_qpIntermediateElectron} & $v_{3}$ & $0.031$ \\ \hline
%4 &\texttt{\footnotesize B\_qpMuon} & $v_{4}$ & $0.026$ \\ \hline
%5 &\texttt{\footnotesize B\_ROE\_PThetacms0} & $v_{5}$ & $0.020$ \\ \hline
%6 &\texttt{\footnotesize B\_nROEDistTrk} & $v_{6}$ & $0.020$ \\ \hline
%7 &\texttt{\footnotesize B\_qpElectron} & $v_{7}$ & $0.019$ \\ \hline
%8 &\texttt{\footnotesize B\_ROECharge0} & $v_{8}$ & $0.018$ \\ \hline
%9 &\texttt{\footnotesize B\_qpIntermediateMuon} & $v_{9}$ & $0.013$ \\ \hline
%10 &\texttt{\footnotesize B\_nROETrk0} & $v_{10}$ & $0.010$ \\ \hline
%11 &\texttt{\footnotesize B\_TagVPvalue} & $v_{11}$ & $0.007$ \\ \hline
%12 &\texttt{\footnotesize B\_nKaonInROE} & $v_{12}$ & $0.004$ \\ \hline
...
%\caption{Hyper-parameter optimization of \texttt{\footnotesize nTrees} and \texttt{\footnotesize nLevels} in the BDT forest training of hadronically decayed candidates.}
%\end{figure}
%
%\subsection{Results}
%
