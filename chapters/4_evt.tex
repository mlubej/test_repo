...
Figures \ref{fig:evars} and \ref{fig:muvars} show the impact parameters $d_0$ and $z_0$, the momentum in  $\Upsilon(4S)$ center-of-mass system (CMS), and the PID information for true and fake electrons and muons from any source, where an extra category for true electrons/muons from the signal $B$ meson decay is shown. The difference between the true leptopns from any source and those from signal decays is due to the distinct kinematics of the parent's decay to the electron.
