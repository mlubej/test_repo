...
\begin{table}[H]
	...
	\begin{tabular}{l|l}
		...
		\toprule
		Signal & $489 \pm 86$ \\
		$q \bar q$ background & $ 2307 \pm 178 $ \\
		$C_0$ & $ 45 \pm 7 $ \\
		$C_1$ & $ 57 \pm 8 $\\
		$C_2$ & $ 69 \pm 9 $ \\
		$C_3$ & $ 909 \pm 57 $ \\
		...
		$C_5$ & $ 222 \pm 18 $ \\
		$C_6$ & $ 320 \pm 108 $ \\
		Other $B \bar B$ background & $ 16462 \pm 245 $ \\
		\bottomrule
	\end{tabular}
	\captionsetup{width=.8\linewidth}
...
\begin{table}[H]
	...
	\begin{tabular}{l|l||l|l}
		...
		$\mathcal{B}_{11}$ & $1.253 \pm 0.443$ & $N_{45}$ & $3 \pm 2$\\
		$N_{\mathrm{control}}^{MC}$ & $1181 \pm 11$ & $N_{50}$ & $103 \pm 10$\\
		$N_{\mathrm{control}}^{Data}$ & $1214 \pm 43$ & $N_{51}$ & $64 \pm 8$\\
...
\begin{equation*}
\bar N {}_{sig} = 489 \pm 85,\quad \mathrm{fit~significance} = 5.9\sigma,
\end{equation*}
...
\begin{equation}
\sigma_{\mathrm{stat}} = 81,\quad \sigma_{\mathrm{sys}}^{GC} = 26,\quad \delta_{\mathrm{sys}}^{GC} = 5.3\%,
\end{equation}
...
\begin{table}[H]
	...
	\begin{tabular}{l|c|c|c}
		...
		\toprule
		$\ell = e$ or $\mu$ & $1.57$ & $1.55 \pm 0.15$ & $3.04 \pm 0.54 {}^{+0.74}_{-0.71}$\\
		\bottomrule
	\end{tabular}
	\captionsetup{width=.8\linewidth}
