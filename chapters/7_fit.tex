...
\begin{equation}
\rho = \frac{\mathcal{B}^{PDG}}{\mathcal{B}^{MC}}.
\label{eq:br_fix}
\end{equation}
...
\begin{table}[!htbp]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		Decay & $\mathcal{B}_{MC}$ & $\mathcal{B}_{PDG}$ & Reference \\
		\hline
...
\section{Fit Results}
In this section we present the control fit results on MC and data, along with the control sample branching ratio. We also show results of the signal fit on MC and data. All fits were performed with an initial binning of $20\times20$ bins in \vars.
