...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|c|}
		...
		\hline
        $B^0 \to D {}^{-} \ell^+ \nu$ & $2.13\E{-2}$ & $(2.13 \pm 0.09)\E{-2}$ & \multirow{2}{*}{\cite{Amhis:2016xyh}} \\ 
		\cline{1-3}
        $B^0 \to D {}^{*-} \ell^+ \nu$ & $5.33\E{-2}$ & $(4.88 \pm 0.11)\E{-2}$ & \\
        \hline
        $B^+ \to \bar D {}^{0} \ell^+ \nu$ & $2.31\E{-2}$ & $(2.29 \pm 0.10)\E{-2}$ & \multirow{2}{*}{[calc.]} \\ 
        \cline{1-3}
        $B^+ \to \bar D {}^{*0} \ell^+ \nu$ & $5.79\E{-2}$ & $(5.25 \pm 0.12)\E{-2}$ & \\
        \hline
		$D^0 \to K^-K^+$ & $3.9\E{-3}$ & $(3.97\pm0.07)\E{-3}$ & \cite{tanabashi2018review} \\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|c|}
		...
		Decay & $\mathcal{B}_{GEN}$ & $\mathcal{B}_{PDG}$ & Reference \\
		\hline
        $D^0 \to K^-\pi^+$ & $3.82\E{-2}$ & $(3.89\pm0.04)\E{-2}$ & \multirow{7}{*}{ \cite{tanabashi2018review}} \\
		\cline{1-3}
        $D^0 \to K^-K^+\pi^0$ & $2.36\E{-3}$ & $(3.37\pm0.15)\E{-3}$ & \\
		\cline{1-3}
		$D^0 \to K^-\pi^+\pi^0$ & $13.08\E{-2}$ & $(14.2\pm0.5)\E{-2}$ &  \\
		\cline{1-3}
        $D^0 \to K^-e^+\nu$ & $3.41\E{-2}$ & $(3.53\pm0.028)\E{-2}$ &  \\
		\cline{1-3}
		$D^0 \to K^-\mu^+\nu$ & $3.41\E{-2}$ & $(3.31\pm0.13)\E{-2}$ &  \\
		\cline{1-3}
        $D^+ \to K^-K^+\pi^+$ & $9.06\E{-3}$ & $(9.51\pm0.34)\E{-3}$ &  \\
		\cline{1-3}
		$D^+ \to K^-\pi^+\pi^+$ & $9.51\E{-2}$ & $(8.98\pm0.28)\E{-2}$ &  \\
		\hline
	\end{tabular}
...
We constructed $3\E{3}$ pseudo data sets, where each data set was generated with the expected amount of each template category, distributed according to the Poisson distribution. All fits were performed with the optimal initial uniform binning of $20\times20$ bins in \vars.

Figure \ref{fig:toyMC} shows distributions of the fit yields, errors and the pull distribution of all pseudo fits. The fits seem to be under control, although there is a slight bias present in the negative direction, which can also be seen in the pull distribution plot. The latter follows a normal distribution with a mean of $(-0.1\pm0.02)$ and standard deviation of $(1.00\pm0.01)$. The mean ($\bar X$) and the standard deviation $(S)$ were calculated in the usual way, while their errors $\sigma_{\bar X}$ and $\sigma_S$ were calculated as \cite{ahn2003standard}
\begin{equation}
...
\section{Fit Results}
In this section we present the firt results of signal and control fits on MC as well as data, along with the control decay branching ratio measurement. We also show results of the signal fit on MC and data.
...
\hline
 & $N^{MC}$ & $N^{\mathrm{data}}$ \\
\hline
$\ell = e$ or $\mu$ & $1180 \pm 11$ & $1198 \pm 44$\\
	\hline
$\ell = e$ & $590 \pm 8$ & $585 \pm 28$ \\
\hline
$\ell = \mu$ & $591 \pm 7$ & $617 \pm 30$\\
	\hline
\end{tabular}
...
\texttt{Wait for referees to get results}.