[/Title (Measurement of the B+ to K+ K- l+ nu Decay with the Belle Detector) 
 /Author (Matic Lubej) 
 /Copyright (\251 2019 Matic Lubej) 
 ...
 /DateSubmitted (November 2018) 
 /Keywords (Belle detector, B mesons, semileptonic decays, branching fraction, inclusive tagging, untagged, rest of event) 
 /University (Faculty of Mathematics and Physics) 
 /AcademicUnit (University of Ljubljana) 
 /Creator (pdfLaTeX with pdfathesis) 
 /Trapped /False 
 /DOCINFO pdfmark 
[/_objdef {icc_PDFA} /type /stream /OBJ pdfmark 
[{icc_PDFA} << /N 3>> /PUT pdfmark 
[{icc_PDFA} (sRGB_IEC61966-2-1_black_scaled.icc) (r) file /PUT pdfmark 
