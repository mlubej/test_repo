...
\draw[fermion]  (2.87939, -0.68404) -- (1,0);
\draw[vector]  (1,0) -- (2.28558, 1.53209) ;
\draw (1,0) node[circle,inner sep=0pt,minimum size=5pt,fill=crimsonred]{};
\node at (-1, -0.3) {$\overline q =\overline d,\overline s,\overline b$};
\node at (2.85, -1) {$\overline p =\overline u,\overline c,\overline t$};
\node at (1, -0.4) {$V_{pq}^{*}$};
\node at (1, 0.5) {$W^{+}$};
\node at (-0.2, 1) {Antiquark interaction};
%\node at (2.8, 1.5) {$Y_{S=0,1}^{+}$};
%\node at (2.8, 0.25) {$\overline{D}{}^{(*)0}$};
\end{tikzpicture} 
