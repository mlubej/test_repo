...
\draw[rounded corners=5,fill=cbosons,fill opacity=0.5] (3.5 + 0.1, -3 - 0.3) rectangle (3.5 + 1, -4 - 0.2) node[pos=0.5,opacity=1,xshift=-3,yshift=0] {\LARGE $W$} \leg{80.38 G}{\phantom{+}$-1$}{\phantom{+}1}{$W$ boson};
...
% other stuff
\node[rotate=90] at (5-0.15,-1.05) {\scalefont{0.35}strong nuclear interaction};
\node[rotate=90] at (6-0.15,-2.1) {\scalefont{0.35}electromagnetic interaction};
\node[rotate=90] at (7-0.15-0.25,-3.3) {\scalefont{0.35}weak nuclear interaction};
