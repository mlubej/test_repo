...
\documentclass[aps,prl,twocolumn,showpacs,superscriptaddress,groupedaddress, linenumbers]{revtex4-1}  % for review and submission
...
\begin{tabular}{l}
	\hspace{2.5cm} BELLE-NOTE-1486\\
	\hspace{2.5cm} Version 1.0 as of \today\\
	\hspace{2.5cm} Author: M. Lubej\\
	\hspace{2.5cm} To be submitted to PRL (?)\\
	\hspace{2.5cm} Comment to {\tt matic.lubej@ijs.si}\\
	\hspace{2.5cm} Committee: Leo Piilonen (chair),\\
	\hspace{2.5cm} Y. Kwon and Z. Liptak\\
\end{tabular}
...
\title{Measurement of the decay \bm{$B^+ \to K^+K^-\ell^+\nu_\ell$} with B2BII}
...
\pacs{11.30.Er, 13.20.$-$v, 13.20.He, 14.40.Nd}
\maketitle
